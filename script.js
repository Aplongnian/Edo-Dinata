...
const nomor_hp_yang_ngirim = "+6289679580214"
const nama_yang_ngirim = "Septian Edo"

// nama love kalian 😍
const nama = "Sayidina Zahra Hendrika Putri"
...
const kata = [
  `Selamat ulang tahun ya sayangku cintaku cantikku ${nama}, 🎂😘`,
  `Jaga kesehatannya terus 🙃`,
  `Selalu tersenyum, apapun yang orang lakuin ke kita ya ${nama}`,
  `Jangan lupa di makan 🍰 nya, walau virtual hehe`,
  `Sekali lagi Happy BirthDay ${nama} cantikku cumill 🥰`
]
